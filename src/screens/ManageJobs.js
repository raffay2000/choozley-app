...
const ManageJobs = ({navigation}) => {
  ...
  const [img, setImg] = useState(require("../../assets/Images/MaskGroup10.png"));
  return (
    <View>
      <SearchArea />
      <Animatable.View
      ...
      >
        ...
        <View style={{ flexDirection: "row" ,alignItems:"center"}}>
          ...
          <Entypo name="share" size={24} color="black" style={{marginLeft:15}}/>
        </View>
      </View>
      <View style={{ alignItems: "center" }}>
        <Image
          source={img}
          style={{ height: 200, width: "95%", resizeMode: "stretch" ,marginTop:15,borderRadius:2}}
        />
        <View
          style={{
            flexDirection: "row",
        ...
        >
          <TouchableOpacity
            onPress={() => {
              setImg(require("../../assets/Images/MaskGroup10.png"));
            }}
          >
            <Image
          ...
          >
            <Image
              ...
              style={{ height: 90, width: 120,borderRadius:10 ,marginHorizontal:5 }}
            />
          </TouchableOpacity>
          <TouchableOpacity
            onPress={() => {
       ...
       <View style={{marginLeft:15}}>
           <Text style={{color:"#323B6E",fontSize:15,marginTop:15,marginBottom:15,fontWeight:"bold"}}>About The Services</Text>
           <Text style={{color:"#BBBCC5"}} >It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout. The point of using Lorem Ipsum is that it has a more-or-less normal distribution of letters, as opposed to using 'Content here, content here', making it look like readable English. Many desktop publishing packages and web page editors now use Lorem Ipsum as their default model text, and a search for 'lorem ipsum' will uncover many web sites still in their infancy. Various versions have evolved over the years, sometimes by accident, sometimes on purpose (injected humour and the like).</Text>
       </View>
       <View style={{alignItems:"center"}}>
       <View style={{backgroundColor:"#BBBCC5",height:1,width:360,marginTop:10 }} />
       </View >
            <View style={{marginTop:10,marginLeft:20,flexDirection:"row",justifyContent:"space-between"}}>
                ...
                <View style={{flexDirection:"row",marginRight:20,alignItems:"center"}}>
                    ...
                    <Text  style={{color:"#323B6E"}}><AntDesign name="star" size={24} color="#D1D112"/> 4.5</Text>
